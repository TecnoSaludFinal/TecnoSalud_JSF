 ...
 * @author Deiver
 */
public class ModificarPeticionCitaServlet extends HttpServlet
{
    @EJB
            ...
            throws ServletException, IOException
    {
        ...
        request.setAttribute("peticionCita", pc);

        rd = getServletContext().getRequestDispatcher("/deiver/ModificarPeticionCita.jsp");
        rd.forward(request, response);
    }
