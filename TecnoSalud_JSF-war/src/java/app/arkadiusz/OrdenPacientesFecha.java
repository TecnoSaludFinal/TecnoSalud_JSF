 ...
 */
public class OrdenPacientesFecha extends HttpServlet {
    @EJB
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        personal = (PersonalAdministrativo) session.getAttribute("entidad");
        session.setAttribute("entidad", personal);
        pacientes = pfl.findAll_fecha();
        request.setAttribute("pac", pacientes);
        rd = getServletContext().getRequestDispatcher("/arkadiusz/listado_pacientes.jsp");
