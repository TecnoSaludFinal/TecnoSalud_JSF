 ...
 * @author JoseAntonio
 */
@WebServlet(name = "ListadoCitas", urlPatterns = {"/listar"})
public class ListadoCitas extends HttpServlet {
   @EJB
   private TipoFormularioFacadeLocal fachadaTipoFormulario;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        List<TipoFormulario> lista;
        
        lista = (List<TipoFormulario>) fachadaTipoFormulario.findAll();
        
        request.setAttribute("lista", lista);
        
        RequestDispatcher rd;
        rd = getServletContext().getRequestDispatcher("/jose/NuevoFormulario.jsp");
