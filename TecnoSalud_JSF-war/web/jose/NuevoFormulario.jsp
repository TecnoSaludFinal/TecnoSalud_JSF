...
//obteniendo el valor que se puso en el campo text del formulario
        miCampoTexto = document.getElementById("Comentario").value;
...
<!-- navigation --> 
 ...
 <!-- body -->
            <div id="lavy-stlpec-box">
                <div id="lavy-stlpec">
                    <div id="latest_properties">
                        ...
                        <form name="new" action="http://localhost:8080/TecnoSalud_JSF-war/nuevoFormulario" method="post" onsubmit="return validar()">
           ...
           <u>Tipo de Sugerencia     </u>    
            ...
            <br><br>
            <u>Redacte en este espacio es contenido de su sugerencia.     </u> 
            <br>
            <br><textarea name="Comentario" id="Comentario" rows="15" cols="60"></textarea>
            <br><br>
            <%-- Botón buscar --%>
