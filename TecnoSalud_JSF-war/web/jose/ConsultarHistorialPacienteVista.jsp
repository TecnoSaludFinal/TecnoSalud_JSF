...
<html>
 ...
 <!-- body -->
            <div id="lavy-stlpec-box">
                <div id="lavy-stlpec">
                    <div id="latest_properties">
                        ...
                        <br>
                        <h4><u>Datos personales del paciente</u></h4>
                    <%      if(lista.size()==0)
                            { 
                 %>
                            
                         <h3>No existe ningun paciente con esos datos. Lo sentimos.</h3>
                ...
                <table border="2" CELLSPACING=10>
                          ...
                          <td><strong>Seguridad Social:  </strong></td> <td> <%= lista.get(0).getNuhsaPaciente().getNuhsa()%></td> </tr>       
                          <td><strong>Nombre:  </strong></td><td> <%= lista.get(0).getNuhsaPaciente().getNombre() %></td></tr>
                          <td><strong>Apellidos: </strong></td><td> <%= lista.get(0).getNuhsaPaciente().getApellidos() %> </td>
                          
                          </tr>
                          <br>
                          </table>
                          <br>
                          <h4><u>Historial Medico</u></h4>
            ...
            <td><%= sdf.format(lista.get(i).getFecha()) %></td> 
            <td><%= lista.get(i).getDescripcion()%></td>
                ...
                <%}if (idRol==1)
                          {
                              %>
                               <td> <a href="gestionHistorialPaciente?do=cons&perfil=<%=lista.get(0).getNuhsaPaciente().getNuhsa()%>">Consultar...</a> </td>
                         <%} 
                          else if (idRol==2)
                         { %>
                          
                          <td> <a href="gestionHistorialPaciente?do=cons&perfil=<%=lista.get(0).getNuhsaPaciente().getNuhsa()%>">Consultar...</a> </td>
                          <td> <a href="gestionHistorialPaciente?do=editar&perfil=<%=lista.get(0).getNuhsaPaciente().getNuhsa()%>">Añadir nuevo diagnostico...</a> </td>
                            <%} 
                            }%>       </table>
	</div>
                </div>
